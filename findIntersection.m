%% Computes the coordinate of the more positive of two circle intersections

function [x_sol,y_sol] = findIntersection(c1, r1, c2, r2)
...
sol = solve([r1==sqrt((x-x1)^2+(y-y1)^2), r2==sqrt((x-x2)^2+(y-y2)^2)]);
